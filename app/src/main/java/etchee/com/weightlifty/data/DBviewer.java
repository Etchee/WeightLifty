...
public class DBviewer extends Activity implements OnItemClickListener {
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = new LinearLayout(DBviewer.this);
        ...
        final Button submitQuery = new Button(DBviewer.this);
        ...
        final TextView help = new TextView(DBviewer.this);
        ...
        final Spinner spinnertable =new Spinner(DBviewer.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(DBviewer.this);
        previous = new Button(DBviewer.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(DBviewer.this);
        next.setText("Next");
        ...
        tvmessage =new TextView(DBviewer.this);
        ...
        final Button customQuery = new Button(DBviewer.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DBviewer.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DBviewer.this,
                    ...
                    if(c2!=null)
                    {
                        ...
                        spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if(!isFinishing()){
                                                ...
                                                new AlertDialog.Builder(DBviewer.this)
                                ...
                                if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                {
                                    ...
                                    final ScrollView addrowsv =new ScrollView(DBviewer.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DBviewer.this);
                                    ...
                                    for(int i=0;i<addnewrownames.size();i++)
                                    {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DBviewer.this);
                        ...
                        {
                            LinearLayout cell = new LinearLayout(DBviewer.this);
    ...
    public void updateDeletePopup(int row)
    {
        ...
        final RelativeLayout lp = new RelativeLayout(DBviewer.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv =new ScrollView(DBviewer.this);
        LinearLayout lcrud = new LinearLayout(DBviewer.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(DBviewer.this,
